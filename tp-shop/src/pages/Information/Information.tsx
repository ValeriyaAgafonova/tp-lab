          ...
          <div className="information__right">
            ...
            {newPr ?  
             ...
             <div className="information__old-price">
               ...
               <p className="information__data__old-price">
                 {oldPr[0]}
               </p><span>{oldPr[1]}</span><p className="information__data__old-price">&#8381;</p></div>
             ...
             <div className="information__new-price__price">
               <p className="information__data__new-price">
                 {newPr[0]}
               </p><span>{newPr[1]}</span><p className="information__data__new-price">&#8381;</p></div>
               <p className="information__text__new-price">цена по акции</p>
             </div>
           </div> : <div className="information__only-price"> <p className="information__text__new-price">цена:</p><p className="information__data__new-price">
                 {oldPr[0]}
               </p><span className="information__span">{oldPr[1]}</span><p className="information__data__new-price">&#8381;</p></div>}
